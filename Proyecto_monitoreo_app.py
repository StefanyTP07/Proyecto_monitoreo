...
st.header("-Alvaro Ivan Alarcon Guizado")
st.header("-Berduzco Ancco Gianina")
st.header("-Florida Serrepe Teyzon")
st.header("-Jener Cesar Huincho Ramos")
st.header("-Stefany Tumpay Paredes")
